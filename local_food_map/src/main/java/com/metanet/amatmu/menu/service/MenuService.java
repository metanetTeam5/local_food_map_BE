...
//import com.metanet.amatmu.menu.dao.MenuRepository; 
//
//
//@Service
...
//
//        Restaurant restaurant = restaurantRepository.findByMember(member);
//
...
//
//        if(!menu.getRestaurant().getId().equals(vendor.getId())){
//            throw new AccessDeniedException("메뉴 수정 권한이 없습니다.");
//        }
//
//
//        //Menu와 Vendor 연결
//        menu.setVendor(menuDTO.getRestaurant());
//        //수정 가능한 필드만 업데이트
